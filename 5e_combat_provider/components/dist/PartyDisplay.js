...
var renderComponent = (uuid, data, slotSettings) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "w-full h-full rounded-md" }, partyPane)
  );
};
...
var PartyDisplay_default = bundle;
export {
  PartyDisplay_default as default
};
