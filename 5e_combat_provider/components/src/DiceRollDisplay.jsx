...
const componentName = "Dice Roll Display";

const acceptedDataTypes = [["digitalDice*", "5eEncounter*"]];

const componentInformation = "source-based dice roll overview";

const componentExplanation = (
	<div className="space-y-2">
		<p>
			This is a DynDash Component that takes in Sources of the following
			Data Types, in order to display the dice roll results combat
			encounters:
		</p>
		<br />
...
const renderComponent = (uuid, data, slotSettings) => {
	...
	return (
		...
		>
			<div className="w-full h-full rounded-md">{rollPane}</div>
		</div>
	);
};
